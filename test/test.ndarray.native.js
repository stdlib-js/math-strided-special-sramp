...
var sramp = tryRequire( resolve( __dirname, './../lib/ndarray.native.js' ) );
var opts = {
	'skip': ( sramp instanceof Error )
};
...
tape( 'the function has an arity of 7', opts, function test( t ) {
	t.strictEqual( sramp.length, 7, 'arity of 7' );
	t.end();
});

tape( 'the function evaluates the ramp function', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var i;
...
tape( 'the function returns a reference to the destination array', opts, function test( t ) {
	...
	out = sramp( x.length, x, 1, 0, y, 1, 0 );
...
tape( 'the function supports negative strides', opts, function test( t ) {
	...
	sramp( N, x, -2, x.length-1, y, -1, y.length-2 );
